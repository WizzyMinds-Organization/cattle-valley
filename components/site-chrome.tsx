...
import { ArrowRight, Facebook, Instagram, Linkedin, MapPin, Youtube } from 'lucide-react';
import { MobileMenu } from './mobile-menu';
import { YOUTUBE_URL, INSTAGRAM_URL, FACEBOOK_URL, LINKEDIN_URL } from '@/lib/social';
